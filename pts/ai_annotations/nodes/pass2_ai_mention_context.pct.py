...
# %% [markdown]
# # nodes.pass2_ai_mention_context
#
# Pass 2: classify why AI appears in the ad (one categorical field
# `ai_mention_context`).
#
# Eligibility comes from `routing/annotation_routing_v1.parquet` column
# `eligible_pass2`. Under `post_filter`, eligibility is Pass-1-positive — so
# Pass 1 must have been written first.

# %%
#|default_exp pass2_ai_mention_context
#|export_as_func true
...
set_node_func_args('pass2_ai_mention_context', run_name=run_name)
show_node_vars('pass2_ai_mention_context', run_name=run_name)
...
# %% [markdown]
# ## Export successes and failures to parquet
